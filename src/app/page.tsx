      ...
      <div className="relative w-[1920px] min-h-[2258px] bg-[#F3E7D2]">
        ...
        <div className="ml-[176px] w-[1744px] min-h-[2258px]">
          ...
          <div className="px-[16px] pt-[16px] pb-[32px]">
            {/* BLUE SUMMARY BANNER */}
            <div className="h-[120px] rounded-[8px] bg-[#7FB1E3] border border-black/20 flex items-stretch overflow-hidden shadow-[0_1px_0_rgba(0,0,0,0.08)]">
              ...
              <div className="w-[120px] bg-[#F4C2A1] border-l border-black/20" />
            </div>
            ...
            <div className="mt-6 grid grid-cols-12 gap-6">
              ...
              <div className="col-span-8 h-[360px]">
                <CardShell
                  ...
                  className="h-[360px]"
                  rightSlot={
                    <button className="text-[10px] px-2 py-[2px] border border-black/30 rounded bg-white hover:bg-black/5 transition">
                      SETTINGS
                    </button>
                  }
                >
              ...
              <div className="col-span-4 h-[360px]">
                <CardShell
                  ...
                  rightSlot={
                    <div className="flex gap-2">
                      <button className="px-2 py-[2px] text-[10px] border border-black/30 rounded bg-white hover:bg-black/5 transition">
                        Active
                      </button>
                      <button className="px-2 py-[2px] text-[10px] border border-black/30 rounded bg-white hover:bg-black/5 transition">
                        Past
                ...
                >
                  {/* Scrollable list (prevents overflow, matches Figma behavior) */}
                  <div className="space-y-3 max-h-[285px] overflow-auto pr-1">
                    {[
                      {
                        title: "Renew Desjardins insurance for Canal House",
                        meta: "CapEx · 245 Ridesau Street",
                        due: "Due 7/31/2025",
                      },
                      {
                      ...
                      <div key={idx} className="flex gap-2 p-3 border border-black/20 rounded bg-[#F8F6F1]">
                        <input type="checkbox" className="mt-1" />
                        <div className="flex-1">
                          <div className="text-[11px] font-semibold">{item.title}</div>
                          <div className="text-[10px] text-gray-500">{item.meta}</div>
                          <div className="mt-1 inline-block text-[10px] px-2 py-[2px] border border-black/30 rounded bg-white">
                            {item.due}
                          </div>
                        </div>
                      </div>
              ...
              <div className="col-span-6 h-[260px]">
                <CardShell title="Total Investment & return" barColor="#B7B0F6" className="h-[260px]">
                  ...
                  <div className="mt-4 grid grid-cols-2 gap-3 text-[10px]">
                    <div className="border border-black/20 rounded p-2 bg-[#F8F6FF]">
              ...
              <div className="col-span-6 h-[260px]">
                <CardShell title="Portfolio Overview" barColor="#F2A089" className="h-[260px]">
                  <div className="grid grid-cols-2 gap-3 text-[10px]">
                    <div className="border border-black/20 rounded p-3 bg-[#FFF6F3]">
                ...
                >
                  <div className="h-[180px] flex items-end gap-3">
                    {[40, 70, 55, 90, 60, 110, 80, 120].map((h, i) => (
                      <div key={i} className="flex-1 border border-black/20 rounded bg-[#FDF6E6] overflow-hidden">
                ...
                <CardShell title="Property Units" barColor="#9CC7F4" className="h-[260px]">
                  ...
                  <div className="mt-4 h-[90px] flex items-end gap-1">
                    {Array.from({ length: 20 }).map((_, i) => (
                      <div
                        key={i}
                        className={`w-[10px] border border-black/30 rounded-sm ${
                          i < 8 ? "bg-[#9CC7F4]" : "bg-[#EAEAEA]"
                        }`}
